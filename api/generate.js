...
2. Deteksi miskonsepsi dan bagian yang kurang.
...
5. Beri nextAction yang jelas: lanjut/review konsep tertentu/ulang dari dasar.
...
Aturan kualitas:
- Jangan cuma meringkas. Pecah materi jadi urutan belajar yang bisa dipelajari bertahap.
- Penjelasan materi harus cukup komprehensif, tetapi dipecah menjadi bagian-bagian pendek, bukan satu paragraf panjang.
- Setiap bagian belajar harus punya: judul, penjelasan, contoh konkret, dan active recall question.
- Pecah materi menjadi konsep inti, definisi, contoh, relasi, dan miskonsepsi.
- Flashcard harus pendek, spesifik, dan menguji active recall.
- Quiz harus bertingkat: definition, understanding, application, analysis.
...
Format JSON wajib:
{
  ...
  "studySections": [
    {"title":"judul bagian belajar","explanation":"penjelasan 2-4 kalimat yang jelas","example":"contoh konkret","activeRecall":"pertanyaan untuk mengecek pemahaman"}
  ],
  "concepts": [
  ...
  "quizzes": [
    {"concept":"nama konsep","level":"definition|understanding|application|analysis","question":"soal","options":["opsi A","opsi B","opsi C","opsi D"],"answerIndex":0,"explanation":"kenapa jawaban benar dan opsi lain kurang tepat"}
  ]
}

Batas jumlah:
- studySections 4-8 bagian.
- concepts 6-12.
- flashcards 12-24.
- quizzes 8-16.`;
}
